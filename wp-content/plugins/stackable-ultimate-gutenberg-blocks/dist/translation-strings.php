...
__( 'Indendation', 'stackable-ultimate-gutenberg-blocks' );
...
__( 'Categories', 'stackable-ultimate-gutenberg-blocks' );
...
__( '%s"Stackable" can not be activated. %s It requires PHP version 5.3.0 or higher, but PHP version %s is used on the site. Please upgrade your PHP version first ✌️ %s Back %s', 'stackable-ultimate-gutenberg-blocks' );
__( '"Stackable" requires PHP version 5.3.0 or higher, but PHP version %s is used on the site.', 'stackable-ultimate-gutenberg-blocks' );
__( '%sStackable Notice%s: We noticed that the Gutenberg plugin is active! Just a heads up, you don\'t need the Gutenberg plugin anymore to use the Block Editor. The Gutenberg plugin may contain non-final features which may not be compatible with some block plugins. %sPlease deactivate the Gutenberg plugin%s unless you really need it. Click the close button on the side to dismiss this notice.', 'stackable-ultimate-gutenberg-blocks' );
